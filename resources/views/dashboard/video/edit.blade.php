                ...
                <div class="col-md-12">
                    <div class="card mb-4">
                        <div class="card-body">
							...
							@endif
                            <div class="card-title mb-3">Edit your video</div>
                            <form method="POST" action="{{ route('video.update', $video->path()) }}">
                                @method('PATCH')
                            	@csrf
                                <div class="col-md-12 form-group mb-3">
                                    <label for="firstName1">Video Title</label>
                                    <input class="form-control" id="firstName1" type="text" name="title" value="{{ $video->title }}" placeholder="learn how to be an OAP">
                                </div>
                                <div class="col-md-12 form-group mb-3">
                                    <label for="firstName1">Video URL</label>
                                    <input class="form-control" id="firstName1" type="text" name="url" value="{{ $video->url }}" placeholder="https://youtube.com/aHVwty245">
                                </div>
                                <div class="col-md-12">
