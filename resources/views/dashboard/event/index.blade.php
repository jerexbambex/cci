	...
	<div class="main-content">
        ...
        <div class="row">
            ...
            <div class="col-lg-2 col-md-6 col-sm-12 ml-auto">
                <a href="{{ route('admin.event.create') }}" class="btn btn-rounded btn-primary btn-block mb-4">
	                ...
	                <div class="card card-profile-1 mb-4">
                        <div class="card-body text-center">
                            ...
                            <div class="d-flex justify-content-around text-center col-12">
	                            <form method="POST" action="{{ route('admin.event.delete', $event->path()) }}">
	                            	@method('delete')
	                            	@csrf
	                            	<button type="submit" class="btn btn-default btn-rounded text-danger">Delete</button>
	                            </form>
	                            <a href="{{ route('admin.event.edit', $event->path()) }}" class="btn btn-primary btn-rounded text-white">Edit</a>
	                        </div>
